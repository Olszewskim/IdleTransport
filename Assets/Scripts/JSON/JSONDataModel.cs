...
namespace IdleTransport.JSON {
    public class PlayerJSON {
        ...
        public PlayerJSON(Player player) {
            currenciesDictionary = new Dictionary<CurrencyType, CurrencyJSON>();
    ...
    public class FactoryDataJSON {
        private UnitDataJSON warehouseDataJSON;
    ...
    public class LoadingRampsManagerJSON {
        public List<LoadingRampDataJSON> loadingRampDataJSONList;

        public LoadingRampsManagerJSON(LoadingRampsManager loadingRampsManager) {
            loadingRampDataJSONList = new List<LoadingRampDataJSON>();
